...
*RatingApi* | [**ordersOrderIdParticipantsUserIdRatingPost**](docs/Api/RatingApi.md#ordersorderidparticipantsuseridratingpost) | **POST** /orders/{orderId}/participants/{userId}/rating | Rate a test participant.
